...
CHIP_ERROR chip_ime_AppendCommand_OperationalCredentials_AddNOC(chip::Controller::Device * device, chip::EndpointId ZCLendpointId,
                                                                chip::GroupId, const uint8_t * nOCArray, uint32_t nOCArray_Len,
                                                                ...
                                                                chip::NodeId caseAdminNode, uint16_t adminVendorId)
{
    ...
    cluster.Associate(device, ZCLendpointId);
    return cluster.AddNOC(nullptr, nullptr, chip::ByteSpan(nOCArray, nOCArray_Len), chip::ByteSpan(iPKValue, iPKValue_Len),
